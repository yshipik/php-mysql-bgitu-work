                                ...
                                <div class="flex gap-4">
                                    ...
                                    <dialog id="add_complaint" class="px-8 rounded-md py-6">
                                        <form class="flex flex-col gap-4" method="post">
                                            ...
                                            <input type="text" name="header" id="edit_header" placeholder="Заголовок"
                                                required />
                                            <textarea name="text" id="edit_text" rows="10" placeholder="Описание жалобы"
                                                required> </textarea>
                                            <input type="email" name="email" id="edit_email" placeholder="Ваш email"
                                                required />
